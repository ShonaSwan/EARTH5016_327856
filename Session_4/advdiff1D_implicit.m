...
%Implimenting Implicit Time Integration,  Specificaly 1st - order Backwards
%Euler (BE1) and the semi - Implicit 2nd-order Crank-Nicolson (CN2)

%***** RUN 1D ADVECTION DIFFUSION MODEL (Implicit Time integration) *******
...
while t <= tend
    ...
    i = [i,ind3(3:end-0)];   % degree-of-freedom numbers for nodes i+1
    ...
    switch TINT
        ...
        case 'BE1'  % Backward Euler
             A = At + Ax;       % Assemble coefficient matrix
